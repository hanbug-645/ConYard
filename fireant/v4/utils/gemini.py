...
from utils.config import get_agent_config, load_config
...
class GeminiClient:
    ...
    def generate(
        ...
        """
        return self._call_api(prompt, context, temperature, response_format=None)
    ...
    def generate_json(
        ...
        return self._call_api(prompt, context, temperature, response_format="application/json", suffix=suffix)
